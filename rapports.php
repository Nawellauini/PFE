...
<head>
    ...
    <title>إضافة تقرير | نظام إدارة تقارير التفتيش</title>
...
<body>
        ...
        <div class="container">
            <div class="header-content">
                <div class="logo">
                    ...
                    <h1>نظام إدارة تقارير التفتيش</h1>
                </div>
                <nav class="nav">
                    <ul>
    ...
    <main class="main-content">
        <div class="container">
            <h1 class="page-title"><i class="fas fa-file-medical"></i> إضافة تقرير تفتيش</h1>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="traiter_rapport.php" method="POST" enctype="multipart/form-data" class="form" id="rapport-form">
                        ...
                        <div class="form-group">
                            <label for="id_classe" class="form-label">الفصل</label>
                        ...
                        <div class="form-group">
                            <label for="id_professeur" class="form-label">الأستاذ</label>
                            <select name="id_professeur" id="id_professeur" class="form-control" required>
                                <option value="">اختر فصلاً أولاً</option>
                            </select>
                        </div>
        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-copyright">
                    <p>&copy; <?= date('Y') ?> نظام إدارة تقارير التفتيش. جميع الحقوق محفوظة.</p>
                </div>
            </div>
        </div>
    </footer>
        ...
        $(document).ready(function () {
                ...
                if (id_classe !== "") {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            professeurSelect.append('<option value="">اختر أستاذاً</option>');
                            
                            if (data.length === 0) {
                                professeurSelect.append('<option value="" disabled>لا يوجد أساتذة متاحون لهذا الفصل</option>');
                            } else {
                            ...
                            showToast('success', 'تم تحميل قائمة الأساتذة', 'تم تحميل قائمة الأساتذة بنجاح للفصل المحدد');
                        },
                        error: function () {
                            professeurSelect.html('<option value="">خطأ في التحميل</option>');
                            showToast('error', 'خطأ في التحميل', 'حدث خطأ أثناء تحميل قائمة الأساتذة، يرجى المحاولة مرة أخرى');
                        }
                    });
                } else {
                    professeurSelect.html('<option value="">اختر فصلاً أولاً</option>');
                }
            });
            ...
            function showSuccessToast() {
                showToast(
                    ...
                    'تم حفظ تقرير التفتيش بنجاح في قاعدة البيانات. يمكنك الآن مشاهدته في قائمة التقارير أو إضافة تقرير جديد.'
                );
            }
